...
export const API_PATHS = {
  ...
  clientDetail: (clientId) => `/api/clients/${clientId}`,
  /** @param {string} clientId @returns {string} Ruta de los links de un cliente */
  clientLinks: (clientId) => `/api/clients/${clientId}/links`,
  /** @param {string} clientId @param {string} linkId @returns {string} Ruta de un link especifico */
  clientLinkDetail: (clientId, linkId) => `/api/clients/${clientId}/links/${linkId}`,
};
